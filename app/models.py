...
class Order(BaseModel,db.Model):
    ...
    user_id = db.Column(db.Integer, db.ForeignKey("ihome_user.id"), nullable=False)
    house_id = db.Column(db.Integer, db.ForeignKey("ihome_house.id"), nullable=False)
    house_user_id = db.Column(db.Integer, nullable=False)
    order_id = db.Column(db.String(32), nullable=True)
    begin_date = db.Column(db.String(32), nullable=True)  # 入住时间
    end_date = db.Column(db.String(32), nullable=True)  # 离店时间
